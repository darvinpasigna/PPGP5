      ...
      <nav className={navClassNames} data-bs-theme="dark">
        <div className="container">
          ...
          <div className={`collapse navbar-collapse ${isNavOpen ? 'show' : ''}`} id="navbarSupportedContent">
            ...
            <form className="RightNav d-flex flex-column flex-lg-row" role="search" onSubmit={handleSearch}>
            <div className='rightNav'>
              <div className="input-group input-group-sm mb-3 me-lg-5 pt-3" style={{marginRight: "5px"}}>
                <div className='select' style={{ width: "180px" }}>
                  <select className='form-select' style={{ height: "31px" }} onChange={(e) => setSearchItem(e.target.value)}>
                    <option>All</option>
                ...
                <button className="btn btn-outline-secondary" type="submit" style={{ height: "30px" }}>Search</button>
              </div>
